Scriptname vION_ICBeamPlacer extends ObjectReference
{Tracking beam special effects, summons main beam.}

; === [ vION_ICBeamPlacer.psc ] ==========================================---
; Handles:
;   Placement of tracking beams
;   Placement of the actual beam summoner
; ========================================================---
